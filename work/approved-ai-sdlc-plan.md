...
Технический атлас получает отдельную главу `Persistent Work Graph`. Объектные модели, source-state схемы, safe parallel source-work protocol, Beads/Taskmaster/LangGraph/STORM/CodeCRDT notes и кандидаты на иллюстрации должны уходить в атлас, Handbook или Fieldbook, а не перегружать теоретическую главу.
