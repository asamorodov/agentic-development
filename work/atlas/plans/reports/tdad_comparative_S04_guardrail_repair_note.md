# S04 note: `tdad_comparative`

## Guardrail audit

- Checked concrete read-only path references in the target-group plan: 42 listed paths scanned.
...
- Strengthened visual guardrails around paper tables, benchmark results, dataset diagrams and repo screenshots.
