...
<figure class="source-figure synthetic-figure" id="fig-ii-session-trace-to-state">
  <pre><code>сессия агента
  ...
  → внешнее состояние: что принято, что проверено, что осталось открытым, кто продолжает</code></pre>
  <figcaption>Материал сессии сначала помогает наблюдать и вмешиваться, но для продолжения работы должен перейти во внешнее состояние.</figcaption>
</figure>
