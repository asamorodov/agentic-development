# План целевой группы — Глава X: Gas Town / Beads как организационно-операционный жизненный цикл
...
Глава должна показать Gas Town как организационно-операционный слой: не просто граф задач, а культура координации, обратного давления, сервисных ролей и передачи работы.

PWG здесь граница и предшественник: Gas Town не отменяет устойчивое рабочее состояние, а добавляет организационную оболочку для многих агентов.

Глава должна использовать сильные локальные визуальные материалы, но не превращаться в экскурсию по интерфейсу.

Главная рабочая формула главы:

```text
Собрать ситуацию с несколькими агентами и рабочими площадками: отдельного графа уже мало, нужны обходы, очереди, статусы, сервисные агенты и обратное давление.
```

## 2. Риски и границы

- пересказать Gas Town статью Атласа
- сделать список забавных ролей вместо объяснения функций жизненного цикла
- смешать Beads с обычным таск-трекером
- не показать отличие от PWG и процессных профилей
...
- показать роли как функции жизненного цикла
- развести два слоя Beads: городская координация и рабочая площадка rig
- показать словарь проблемных состояний как операционный язык
- показать сервисных агентов как поддержку процесса, а не декоративных персонажей
...
Особое внимание: Не делать экскурсию по Gas Town. Каждая деталь должна отвечать на вопрос, какую организационную проблему она решает.
...
Рабочая модель: Собрать ситуацию с несколькими агентами и рабочими площадками: отдельного графа уже мало, нужны обходы, очереди, статусы, сервисные агенты и обратное давление.
...
Фокус проверки: Внешний поиск нужен главным образом для восстановления первоисточников и визуальных опор; внутренний Gas Town Атлас должен быть главным донором.
...
Визуальная политика этой главы: локальные Gas Town SVG вероятно полезны; лучше зафиксировать кандидат, если он поддерживает аргумент о координации
