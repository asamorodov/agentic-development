...
### P20 — визуальный слой главы и ремонт ссылок на визуальные материалы
...
Визуальная политика этой главы: искать изображения и схемы, которые показывают продолжение жизненного цикла после merge: repair/update loop, drift cleanup, skill/profile/hook maintenance, post-merge evidence, learning cycle. Если источник даёт реальную lifecycle-схему, сохранить её как candidate/redraw; если глава собирает собственный цикл обслуживания, делать synthetic figure по аргументу главы.
