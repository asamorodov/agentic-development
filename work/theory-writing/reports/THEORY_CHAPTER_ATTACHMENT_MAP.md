...
Документ должен синхронизироваться каждый раз, когда меняется карта Атласа A1–A16, принимается новый theory-ready fragment или меняется граница главы.
...
| CONCLUSION | Свести Теорию к выбору минимально достаточной структуры. | Весь A1–A16 как reference layer, без пересказа. | A10, `00_spine_map`, routing maps. | SPDD, PWG, Gas Town, ADR как deep nodes. | Не превращать conclusion в Рабочие сценарии. |
...
1. меняется список A1–A16 или назначение статьи Атласа;
